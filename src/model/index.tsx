...
export const getDefaultCard = () => ({
    ...
    starAlignment: 'auto',
    starList: [] as string[],
    art: 'https://images-cdn.bridgemanimages.com/api/1.0/image/150.PIX.08161640.7055475/4613001.jpg',
    artData: '',
    artFit: true,
    artSource: 'online',
    ...
    effect: `[Welcome to the ./fade card maker website!]
This is a custom fork of https://lauqerm.github.io/ygocarder. This fork is mostly a french translation and better attribute icons.`,
    setId: 'FADE-FR404',
    atk: '2000',
    def: '2000',
    password: '12345678',
